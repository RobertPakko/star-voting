...
Make a poll, share it, and get an easy an accurate result using [STAR voting](https://en.wikipedia.org/wiki/STAR_voting)
...
| **The options** | You write them · The group provides them, and you close the list |
