-- Renames the "candidates" key in get_poll_results()'s JSON output to
-- "options", matching the app-layer rename (see 0003_creator_email.sql
-- for why the underlying table itself stays named "candidates").
